...
import br.com.unifor.AppManagementClients.constants.Constants;
import br.com.unifor.AppManagementClients.dao.ClienteDao;
import br.com.unifor.AppManagementClients.dao.UFDao;
...
public abstract class AbstractMB {
	...
	public String getRodapePag() {
		...
		retorno.append("Helker Tavora - ");
		retorno.append("Desenvolvimento Com ");
		retorno.append("JSF, HIBERNATE e IREPORT");
